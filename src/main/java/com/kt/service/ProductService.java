...
public class ProductService {
	...
	public Page<Product> searchByKeywordAndStatus(String keyword, List<ProductStatus> statuses, Pageable pageable) {
		String searchKeyword = StringUtils.hasLength(keyword) ? keyword : "";

		return productRepository.findAllByKeywordAndStatuses(keyword, statuses, pageable);
	}
